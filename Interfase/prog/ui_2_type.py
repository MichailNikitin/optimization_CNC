...
################################################################################
## Form generated from reading UI file '2_typeQxGsTF.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_3 = QFrame(self.type_z_lin_widget)
...
"")
        ...
        self.widget_2 = QWidget(self.main_type_z_lin_widget)
        ...
        self.add_stup_pushButton = QPushButton(self.widget_2)
        self.add_stup_pushButton.setObjectName(u"add_stup_pushButton")
        sizePolicy.setHeightForWidth(self.add_stup_pushButton.sizePolicy().hasHeightForWidth())
        self.add_stup_pushButton.setSizePolicy(sizePolicy)
        self.add_stup_pushButton.setMinimumSize(QSize(0, 36))
        font3 = QFont()
        font3.setFamily(u"Tahoma")
        font3.setPointSize(11)
        self.add_stup_pushButton.setFont(font3)

        self.gridLayout_2.addWidget(self.add_stup_pushButton, 0, 0, 1, 1)

        self.delete_stup_pushButton = QPushButton(self.widget_2)
        self.delete_stup_pushButton.setObjectName(u"delete_stup_pushButton")
        sizePolicy1 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.delete_stup_pushButton.sizePolicy().hasHeightForWidth())
        self.delete_stup_pushButton.setSizePolicy(sizePolicy1)
        font4 = QFont()
        font4.setPointSize(11)
        self.delete_stup_pushButton.setFont(font4)

        self.gridLayout_2.addWidget(self.delete_stup_pushButton, 0, 1, 1, 1)

        self.horizontalSpacer = QSpacerItem(135, 32, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_2.addItem(self.horizontalSpacer, 0, 2, 1, 1)


        self.gridLayout.addWidget(self.widget_2, 8, 0, 1, 2)

        self.verticalSpacer_2 = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.gridLayout.addItem(self.verticalSpacer_2, 9, 0, 1, 1)

        self.scrollArea = QScrollArea(self.main_type_z_lin_widget)
        self.scrollArea.setObjectName(u"scrollArea")
        sizePolicy1.setHeightForWidth(self.scrollArea.sizePolicy().hasHeightForWidth())
        self.scrollArea.setSizePolicy(sizePolicy1)
        self.scrollArea.setMinimumSize(QSize(0, 140))
        self.scrollArea.setStyleSheet(u"")
        self.scrollArea.setFrameShape(QFrame.NoFrame)
        self.scrollArea.setWidgetResizable(True)
        self.type_z_scrollArea = QWidget()
        self.type_z_scrollArea.setObjectName(u"type_z_scrollArea")
        self.type_z_scrollArea.setGeometry(QRect(0, 0, 627, 140))
        self.gridLayout_3 = QGridLayout(self.type_z_scrollArea)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.gridLayout_3.setHorizontalSpacing(18)
        self.gridLayout_3.setVerticalSpacing(7)
        self.input_type_z_lin_label = QLabel(self.type_z_scrollArea)
        ...
        self.input_type_z_stup_label = QLabel(self.type_z_scrollArea)
        ...
        self.dz_label = QLabel(self.type_z_scrollArea)
        ...
        self.dlin_one_textbox = QLineEdit(self.type_z_scrollArea)
...
"")
        ...
        self.dlin_one_label = QLabel(self.type_z_scrollArea)
        ...
        self.line = QFrame(self.type_z_scrollArea)
        ...
        self.dz_textbox = QLineEdit(self.type_z_scrollArea)
...
"}")
        ...
        self.scrollArea.setWidget(self.type_z_scrollArea)

        self.gridLayout.addWidget(self.scrollArea, 3, 0, 5, 3)
...
"")
        ...
        self.horizontalSpacer_3 = QSpacerItem(80, 60, QSizePolicy.Fixed, QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.add_stup_pushButton.setText(QCoreApplication.translate("MainWindow", u"  + \u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u0441\u0442\u0443\u043f\u0435\u043d\u044c  ", None))
        self.delete_stup_pushButton.setText(QCoreApplication.translate("MainWindow", u"-", None))
